...
(function ($, Badges) {
    ...
    var init = function () {
        $(function () {
            $(".p2pu-tab").p2puSlider({navbarContainer: '.navbar', icon: '.p2pu-tab-icon', iconUp: 'icon-chevron-sign-down', iconDown: 'icon-chevron-sign-up'});
    ...
    var dropdown_search_handler = function () {
        var search_form = $('.dropdown-menu'), dropdown_button = $('.dropdown-toggle');
    ...
    var clear_search_button_handler = function () {
        var clear = $('.clear-search'), search = $('.search');
        clear.bind('click', function () {
            search.val('');
        });
    };
    var side_plugin_handler = function () {
        $('.navbar-btn').sidr({name: 'main-menu-panel', source: '.nav-collapse.collapse'});
    };
    Badges.Splash = {};
