...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Award.ob_state'
        db.add_column('badge_award', 'ob_state',
                      self.gf('django.db.models.fields.CharField')(default='NOT_PUBLISHED', max_length=20),
                      keep_default=False)

        # Adding field 'Award.ob_date_published'
        db.add_column('badge_award', 'ob_date_published',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Award.ob_date_revoked'
        db.add_column('badge_award', 'ob_date_revoked',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Award.ob_state'
        db.delete_column('badge_award', 'ob_state')

        # Deleting field 'Award.ob_date_published'
        db.delete_column('badge_award', 'ob_date_published')

        # Deleting field 'Award.ob_date_revoked'
        db.delete_column('badge_award', 'ob_date_revoked')
